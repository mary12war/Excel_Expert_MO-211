...
// Starter bank (expandable). The exam runner will sample/weight across domains.
export const questionBank: QuizQuestion[] = [
  ...
  },
  {
    ...
    topicSlug: "xlookup",
    prompt:
      "What’s a key advantage of XLOOKUP compared to VLOOKUP?",
    choices: [
  ...
  },
  {
    ...
    answerId: "b",
    explanation:
      "PMT expects rate per period. For monthly payments, use APR/12."
  },
  ...
  },
  {
    ...
    prompt:
      "Remove Duplicates works best when…",
    choices: [
  ...
  // Domain 1
  {
    ...
    prompt:
      "Protect Workbook (Structure) prevents users from…",
    choices: [
  ...
  // Domain 4
  {
    ...
    prompt:
      "A slicer in a PivotTable is primarily used to…",
    choices: [
